...
function Start() {
    return(
        <div>
            <svg className='clear' width="300" height="139" viewBox="0 0 447 139" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* <Button path = "../pages/Questions" text = "Restart" /> */}
            <text x="50" y="50" fontSize={60} fill='white'>Restart</text>
